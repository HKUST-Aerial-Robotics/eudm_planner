...
class EudmPlannerMapAdapter : public EudmPlannerMapItf {
 public:
  ...
  ErrorType GetUncertainVehicleIds(
      std::vector<int> *uncertain_vehicle_ids) override;
  ...
  ErrorType LateralBehaviorPredictionUsingMobil(
      const common::Vehicle &vehicle, const common::VehicleSet &nearby_vehicles,
      std::set<std::pair<decimal_t, common::LateralBehavior>> *res) override;
